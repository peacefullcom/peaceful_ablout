        ...
        @csrf
         ...
         <div class="col-sm-8 offset-sm-2 col-xs-12"> 
            <div class="form-group row">
              ...
              <input class="col-sm-9 col-xs-12 form-control" id="name" name="name" type="text" value="{{ $author->name }}">
            </div>

            <div class="form-group row">
              <label for="title" class="col-sm-3 col-xs-12 required">title</label>
              <input class="col-sm-9 col-xs-12 form-control" id="title" name="title" type="text" value="{{ $author->title }}">
            </div>

            <div class="form-group row">
              <label for="description" class="col-sm-3 col-xs-12 required">description</label>
              <input class="col-sm-9 col-xs-12 form-control" id="description" name="description" type="text" value="{{ $author->description }}">
            </div>
