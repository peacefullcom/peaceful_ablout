...
<!-- form start -->
        ...
        <div class="col-sm-8 offset-sm-2 col-xs-12">
            ...
            <div class="form-group row">
              ...
              <input class="col-sm-9 col-xs-12 form-control" id="username" name="username" type="text" value="{{ $admin->username }}">
            </div>
            <div class="form-group row">
              <label for="first_name" class="col-sm-3 col-xs-12 required">First Name</label>
              <input class="col-sm-9 col-xs-12  form-control" id="first_name" name="first_name" type="text" value="{{ $admin->first_name }}">
            </div>
            <div class="form-group row">
              <label for="last_name" class="col-sm-3 col-xs-12 required">Last Name</label>
              <input class="col-sm-9 col-xs-12  form-control" id="last_name" name="last_name" type="text" value="{{ $admin->last_name }}">
            </div>
            <div class="form-group row">
              <label for="phone" class="col-sm-3 col-xs-12 required">Phone</label>
              <input class="col-sm-9 col-xs-12  form-control" id="phone" name="phone" type="text" value="{{ $admin->phone }}">
            </div>
            <div class="form-group row">
              <label for="password" class="col-sm-3 col-xs-12 required">Initial Password</label>
              <input class="col-sm-9 col-xs-12  form-control" id="password" name="password" type="text" value="">
            </div>
            <div class="form-group row">
