    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <a class="btn btn-info" href="/backend/article-category/create">
                Create
          </a>
        </div>
                ...
                @foreach($articleCategories as $articleCategory)
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-info btn-sm" href="/backend/article-category/edit/{{ $articleCategory->id }}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="javascript:if(confirm('确定要删除吗？'))location='/backend/article-category/delete/{{ $articleCategory->id }}'">
