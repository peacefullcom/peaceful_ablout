...
<head>
  ...
  <title>Peaceful | Dashboard</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link"  title="refresh">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
            <a href="/backend/change-profile" class="dropdown-item">My Profile</a>
            <a href="/backend/change-password" class="dropdown-item">Change Password</a>
            <a href="/backend/logout" class="dropdown-item">Logout</a>
        </div>
      </li>
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Peaceful ADMIN</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="/backend/system-account" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>System Account</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/backend/article-category" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Article Category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/backend/article" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Article List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/backend/vote" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Vote List</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020-2022 <a href="https://about.peacefulmall.com">Peacefulmall.com</a>.</strong>
    All rights reserved.
