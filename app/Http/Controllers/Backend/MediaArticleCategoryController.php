<?php
/**
 * ClassName: MediaArticleCategoryController
 * 文章分类控制器
...
class MediaArticleCategoryController extends Controller
{  
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.media_article_category.index')->with('articleCategories', $articleCategories);
    }
    ...
    public function create(Request $request)
    {
        if($request->has('submit')) {
            ...
            $id = MediaArticleCategory::create([
        ...
        return view('backend.media_article_category.create');
    }
    ...
    {
        $articleCategory = MediaArticleCategory::find($id);
        if(!$articleCategory) {
        ...
        return view('backend.media_article_category.edit',compact('articleCategory'));
    }
